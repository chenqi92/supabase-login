import { AdminCreateForm } from "@/components/auth/admin-create-form";
    ...
    <div className="container relative h-screen flex-col items-center justify-center grid lg:max-w-none lg:grid-cols-2 lg:px-0">
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
        <div className="absolute inset-0 bg-zinc-900">
          <div className="absolute inset-0 bg-gradient-to-br from-red-600/30 via-red-500/20 to-transparent" />
        </div>
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              &ldquo;这个页面允许创建具有完全管理权限的超级管理员账户，请谨慎使用此功能。&rdquo;
            </p>
            <footer className="text-sm">系统管理</footer>
          </blockquote>
        </div>
      </div>
